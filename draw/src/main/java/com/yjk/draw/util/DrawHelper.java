...
public class DrawHelper {
    ...
    static public Paint createPaint() {
    ...
    static public void setupFillPaint(Paint paint) {
        paint.setStyle(Paint.Style.FILL);
    }

    static public void setupStrokePaint(Paint paint) {
    ...
    public static void copyFromPaint(Paint from, Paint to, boolean copyWidth) {
