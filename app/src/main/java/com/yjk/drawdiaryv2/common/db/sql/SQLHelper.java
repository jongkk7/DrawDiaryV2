package com.yjk.drawdiaryv2.common.db.sql;
...
public class SQLHelper {
    ...
    public long INSERT(String time, int weather, byte[] url, byte[] all_url, String write){
    ...
    public int UPDATE(String id, String time, int weather, byte[] url, byte[] all_url, String write) {
        ContentValues values = new ContentValues();
        values.put(Database.Entry.TIME, time);
        values.put(Database.Entry.WEATHER, weather);
        values.put(Database.Entry.URL, url);
